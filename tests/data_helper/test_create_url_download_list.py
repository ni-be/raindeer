...
class TestURLDownloadList(unittest.TestCase):
    ...
    def test_create_url_download_list(self, mock_yaml_reader):
        ...
        # check the output
        expected_output = ['https://opendata.dwd.de/climate_environment/CDC/regional_averages_DE/annual/precipitation/regional_averages_rr_year.txt','https://opendata.dwd.de/climate_environment/CDC/regional_averages_DE/monthly/precipitation/regional_averages_rr_{}.txt']
